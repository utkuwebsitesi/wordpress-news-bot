...
try{
    ...
    $excluded='~(?:^|/)(?:\.git|\.github|\.tmp-history-build|tests|bin|dist|vendor|node_modules|coverage|cache|src)(?:/|$)|(?:^|/)(?:\.env(?:\..*)?|composer\.(?:json|lock)|package(?:-lock)?\.json|playwright\.config\.js|phpunit\.xml\.dist|\.gitignore|\.phpunit\.result\.cache)$|\.zip$~i';
