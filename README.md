...
Durum: **release candidate / medya P0 kabulü bekliyor**. Production deploy yapılmamıştır; gerçek WordPress + MariaDB ortamında medya dosyası, attachment kaydı ve `_thumbnail_id` birlikte doğrulanmadan `0.4.0-rc.2` hazır veya production-ready kabul edilmez.
