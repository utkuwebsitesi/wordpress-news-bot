...
final class SourceServiceTest extends TestCase
{
    ...
    public function testPrimaryHostIsDerivedAutomaticallyFromFeedUrl(): void
    {
        $this->service->save(['name'=>'AA','feed_url'=>'https://www.aa.com.tr/rss','allowed_domains'=>'','category_id'=>0,'active'=>1]);
