...
final class SqliteWpdb
{
    ...
    public function __construct(){
        ...
        foreach([
            'CREATE TABLE wp_wpnb_sources (id INTEGER PRIMARY KEY,name TEXT,feed_url TEXT,canonical_hash TEXT DEFAULT "",active INTEGER DEFAULT 1,category_id INTEGER DEFAULT 0,daily_quota INTEGER DEFAULT 10,priority INTEGER DEFAULT 100,allowed_domains TEXT,import_images INTEGER DEFAULT 1,draft_without_image INTEGER DEFAULT 1,use_og_image INTEGER DEFAULT 0,last_checked_at TEXT,last_result TEXT,last_error TEXT,created_at TEXT,updated_at TEXT)',
