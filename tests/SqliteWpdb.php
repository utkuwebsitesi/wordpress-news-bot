...
final class SqliteWpdb
{
    ...
    public function __construct(){
        ...
        foreach([
            'CREATE TABLE wp_wpnb_sources (id INTEGER PRIMARY KEY,name TEXT,feed_url TEXT,canonical_hash TEXT DEFAULT "",active INTEGER DEFAULT 1,category_id INTEGER DEFAULT 0,allowed_domains TEXT,created_at TEXT,updated_at TEXT)',
