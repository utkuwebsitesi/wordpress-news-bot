...
final class DatabaseSchemaTest extends TestCase
{
    ...
    public function testRepairSchemaContainsEveryProductionTable():void{$this->assertSame(['sources','feed_items','jobs','ai_generations','logs','daily_usage','automation_runs','migration_journal'],array_keys(DatabaseSchema::tables()));}
