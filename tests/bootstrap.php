...
if (!defined('WPNB_VERSION')) { define('WPNB_VERSION', '0.4.0-rc.1'); }
...
require dirname(__DIR__) . '/includes/SourceTestException.php'; require dirname(__DIR__) . '/includes/SourceConnectionTester.php'; require dirname(__DIR__) . '/includes/SourceService.php'; require dirname(__DIR__) . '/includes/SourceImporter.php'; require dirname(__DIR__) . '/includes/ManualImportService.php'; require dirname(__DIR__) . '/includes/DuplicateDetector.php'; require dirname(__DIR__) . '/includes/DraftService.php'; require dirname(__DIR__) . '/includes/SourceRecoveryRequired.php'; require dirname(__DIR__) . '/includes/SourceMigration.php';
