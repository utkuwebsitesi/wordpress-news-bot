...
require dirname(__DIR__) . '/includes/SourceTestException.php'; require dirname(__DIR__) . '/includes/SourceConnectionTester.php'; require dirname(__DIR__) . '/includes/RemoteAssetException.php'; require dirname(__DIR__) . '/includes/RemoteAssetFetcher.php'; require dirname(__DIR__) . '/includes/ImageValidator.php'; require dirname(__DIR__) . '/includes/ImageImportService.php'; require dirname(__DIR__) . '/includes/SourceService.php'; require dirname(__DIR__) . '/includes/SourceImporter.php'; require dirname(__DIR__) . '/includes/ManualImportService.php'; require dirname(__DIR__) . '/includes/DuplicateDetector.php'; require dirname(__DIR__) . '/includes/DraftService.php'; require dirname(__DIR__) . '/includes/PoolBulkService.php'; require dirname(__DIR__) . '/includes/DraftMaintenanceService.php'; require dirname(__DIR__) . '/includes/SourceRecoveryRequired.php'; require dirname(__DIR__) . '/includes/SourceMigration.php';
