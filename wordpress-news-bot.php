...
define('WPNB_VERSION', '0.5.0-rc.3');
...
require_once WPNB_DIR . 'includes/CronHealth.php';
require_once WPNB_DIR . 'includes/CriticalErrorGuard.php';
...
require_once WPNB_DIR . 'includes/RemoteAssetFetcher.php';
require_once WPNB_DIR . 'includes/ImageValidator.php';
require_once WPNB_DIR . 'includes/ImageImportService.php';
...
require_once WPNB_DIR . 'includes/AiOutputRejectedException.php';
require_once WPNB_DIR . 'includes/AiOriginalityValidator.php';
