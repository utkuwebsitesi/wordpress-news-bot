...
final class DatabaseSchema
{
    ...
    public static function tables(): array
    {
        return [
            'sources'=>['columns'=>[
                'id'=>'bigint(20) unsigned NOT NULL AUTO_INCREMENT','name'=>'varchar(190) NOT NULL','feed_url'=>'text NOT NULL','canonical_hash'=>"char(64) NOT NULL DEFAULT ''",'active'=>'tinyint(1) NOT NULL DEFAULT 1','category_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','daily_quota'=>'int unsigned NOT NULL DEFAULT 10','interval_minutes'=>'int unsigned NOT NULL DEFAULT 60','reliability'=>"varchar(20) NOT NULL DEFAULT 'medium'",'author_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','post_status'=>"varchar(20) NOT NULL DEFAULT 'draft'",'show_attribution'=>'tinyint(1) NOT NULL DEFAULT 1','import_images'=>'tinyint(1) NOT NULL DEFAULT 1','draft_without_image'=>'tinyint(1) NOT NULL DEFAULT 1','use_og_image'=>'tinyint(1) NOT NULL DEFAULT 0','allowed_domains'=>'text NULL','last_success'=>'datetime NULL','last_checked_at'=>'datetime NULL','last_result'=>'varchar(255) NULL','last_error'=>'text NULL','created_at'=>'datetime NOT NULL','updated_at'=>'datetime NOT NULL',
            ...
            'feed_items'=>['columns'=>[
                'id'=>'bigint(20) unsigned NOT NULL AUTO_INCREMENT','source_id'=>'bigint(20) unsigned NOT NULL','source_name'=>"varchar(190) NOT NULL DEFAULT ''",'source_feed_url'=>'text NULL','guid'=>"varchar(255) NOT NULL DEFAULT ''",'source_url'=>'text NOT NULL','normalized_url'=>"varchar(512) NOT NULL DEFAULT ''",'title'=>'text NOT NULL','excerpt'=>'text NULL','source_category'=>"varchar(190) NOT NULL DEFAULT ''",'wordpress_category_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','wordpress_post_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','content_hash'=>"char(64) NOT NULL DEFAULT ''",'image_url'=>'text NULL','image_source'=>"varchar(30) NOT NULL DEFAULT ''",'image_status'=>"varchar(20) NOT NULL DEFAULT 'missing'",'image_attachment_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','image_hash'=>"char(64) NOT NULL DEFAULT ''",'image_error_code'=>"varchar(50) NOT NULL DEFAULT ''",'published_at'=>'datetime NULL','status'=>"varchar(30) NOT NULL DEFAULT 'new'",'raw_data'=>'longtext NULL','created_at'=>'datetime NOT NULL','updated_at'=>'datetime NOT NULL',
