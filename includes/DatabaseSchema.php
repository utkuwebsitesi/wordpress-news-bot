...
final class DatabaseSchema
{
    ...
    public static function tables(): array
    {
        return [
            ...
            'feed_items'=>['columns'=>[
                'id'=>'bigint(20) unsigned NOT NULL AUTO_INCREMENT','source_id'=>'bigint(20) unsigned NOT NULL','source_name'=>"varchar(190) NOT NULL DEFAULT ''",'source_feed_url'=>'text NULL','guid'=>"varchar(255) NOT NULL DEFAULT ''",'source_url'=>'text NOT NULL','normalized_url'=>"varchar(512) NOT NULL DEFAULT ''",'title'=>'text NOT NULL','excerpt'=>'text NULL','source_category'=>"varchar(190) NOT NULL DEFAULT ''",'wordpress_category_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','content_hash'=>"char(64) NOT NULL DEFAULT ''",'published_at'=>'datetime NULL','status'=>"varchar(30) NOT NULL DEFAULT 'new'",'raw_data'=>'longtext NULL','created_at'=>'datetime NOT NULL','updated_at'=>'datetime NOT NULL',
