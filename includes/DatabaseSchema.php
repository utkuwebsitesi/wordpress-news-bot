...
final class DatabaseSchema
{
    ...
    public static function tables(): array
    {
        return [
            ...
            'feed_items'=>['columns'=>[
                'id'=>'bigint(20) unsigned NOT NULL AUTO_INCREMENT','source_id'=>'bigint(20) unsigned NOT NULL','source_name'=>"varchar(190) NOT NULL DEFAULT ''",'source_feed_url'=>'text NULL','guid'=>"varchar(255) NOT NULL DEFAULT ''",'source_url'=>'text NOT NULL','normalized_url'=>"varchar(512) NOT NULL DEFAULT ''",'title'=>'text NOT NULL','excerpt'=>'text NULL','source_category'=>"varchar(190) NOT NULL DEFAULT ''",'wordpress_category_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','content_hash'=>"char(64) NOT NULL DEFAULT ''",'image_url'=>'text NULL','image_source'=>"varchar(30) NOT NULL DEFAULT ''",'image_status'=>"varchar(20) NOT NULL DEFAULT 'missing'",'image_attachment_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','image_hash'=>"char(64) NOT NULL DEFAULT ''",'image_error_code'=>"varchar(50) NOT NULL DEFAULT ''",'published_at'=>'datetime NULL','status'=>"varchar(30) NOT NULL DEFAULT 'new'",'raw_data'=>'longtext NULL','created_at'=>'datetime NOT NULL','updated_at'=>'datetime NOT NULL',
            ],'indexes'=>['PRIMARY'=>['unique'=>true,'columns'=>['id']],'source_guid'=>['unique'=>true,'columns'=>['source_id','guid']],'source_id'=>['unique'=>false,'columns'=>['source_id']],'normalized_url'=>['unique'=>false,'columns'=>['normalized_url']],'content_hash'=>['unique'=>false,'columns'=>['content_hash']],'image_status'=>['unique'=>false,'columns'=>['image_status']],'image_attachment_id'=>['unique'=>false,'columns'=>['image_attachment_id']],'image_hash'=>['unique'=>false,'columns'=>['image_hash']]]],
