...
final class DatabaseSchema
{
    ...
    public static function tables(): array
    {
        return [
            'sources'=>['columns'=>[
                'id'=>'bigint(20) unsigned NOT NULL AUTO_INCREMENT','name'=>'varchar(190) NOT NULL','feed_url'=>'text NOT NULL','canonical_hash'=>"char(64) NOT NULL DEFAULT ''",'active'=>'tinyint(1) NOT NULL DEFAULT 1','category_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','daily_quota'=>'int unsigned NOT NULL DEFAULT 10','interval_minutes'=>'int unsigned NOT NULL DEFAULT 60','reliability'=>"varchar(20) NOT NULL DEFAULT 'medium'",'author_id'=>'bigint(20) unsigned NOT NULL DEFAULT 0','post_status'=>"varchar(20) NOT NULL DEFAULT 'draft'",'show_attribution'=>'tinyint(1) NOT NULL DEFAULT 0','import_images'=>'tinyint(1) NOT NULL DEFAULT 1','draft_without_image'=>'tinyint(1) NOT NULL DEFAULT 1','use_og_image'=>'tinyint(1) NOT NULL DEFAULT 0','allowed_domains'=>'text NULL','last_success'=>'datetime NULL','last_checked_at'=>'datetime NULL','last_result'=>'varchar(255) NULL','last_error'=>'text NULL','created_at'=>'datetime NOT NULL','updated_at'=>'datetime NOT NULL',
