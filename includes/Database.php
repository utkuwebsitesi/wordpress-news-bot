...
final class Database
{
    public static function activate(): void
    {
        ...
        $tables = [
            'sources' => "id bigint(20) unsigned NOT NULL AUTO_INCREMENT, name varchar(190) NOT NULL, feed_url text NOT NULL, active tinyint(1) NOT NULL DEFAULT 1, category_id bigint(20) unsigned NOT NULL DEFAULT 0, daily_quota int unsigned NOT NULL DEFAULT 10, interval_minutes int unsigned NOT NULL DEFAULT 60, reliability varchar(20) NOT NULL DEFAULT 'medium', author_id bigint(20) unsigned NOT NULL DEFAULT 0, post_status varchar(20) NOT NULL DEFAULT 'draft', show_attribution tinyint(1) NOT NULL DEFAULT 1, allowed_domains text NULL, last_success datetime NULL, last_error text NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (id), KEY active (active)",
            'feed_items' => "id bigint(20) unsigned NOT NULL AUTO_INCREMENT, source_id bigint(20) unsigned NOT NULL, guid varchar(255) NOT NULL DEFAULT '', source_url text NOT NULL, normalized_url varchar(512) NOT NULL DEFAULT '', title text NOT NULL, excerpt text NULL, content_hash char(64) NOT NULL DEFAULT '', published_at datetime NULL, status varchar(30) NOT NULL DEFAULT 'new', raw_data longtext NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (id), UNIQUE KEY source_guid (source_id,guid(191)), KEY normalized_url (normalized_url(191)), KEY content_hash (content_hash)",
            'jobs' => "id bigint(20) unsigned NOT NULL AUTO_INCREMENT, feed_item_id bigint(20) unsigned NOT NULL, type varchar(30) NOT NULL, status varchar(20) NOT NULL DEFAULT 'queued', attempts tinyint unsigned NOT NULL DEFAULT 0, locked_at datetime NULL, error_message text NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (id), KEY status (status)",
