...
if (!empty($settings['delete_data_on_uninstall'])) {
    ...
    foreach(['wpnb_settings','wpnb_schema_version','wpnb_setup_state','wpnb_connection_status','wpnb_openai_credentials','wpnb_last_automation_run','wpnb_source_recovery_required','wpnb_engine_repair_state','wpnb_diagnostics']as$option)delete_option($option);
